...
Always update VERSION constant in file version.py immediately after making code changes. Increment the version according to the nature of the changes made (patch, minor, major) following semantic versioning principles.
