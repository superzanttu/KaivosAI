...
Always update VERSION constant immediately after makin code changes. Increment the version according to the nature of the changes made (patch, minor, major) following semantic versioning principles.